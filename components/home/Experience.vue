<template>
  <section
    id="experience"
    class="relative flex flex-col items-center justify-center px-8 py-20 space-y-16 overflow-hidden text-gray-800 dark:text-white transition-colors duration-500"
  >
    <!-- Title -->
