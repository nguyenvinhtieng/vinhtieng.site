  ...
  >
    <div class="aspect-video bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 overflow-hidden rounded-t-lg relative">
      ...
      <div v-else class="w-full h-full flex items-center justify-center">
        <NuxtIcon name="game" class="text-6xl text-gray-400 dark:text-gray-600" />
      </div>
      ...
      <!-- Badge/Icon overlay -->
      <div v-if="isMine" class="absolute top-3 right-3 px-2 py-1 bg-green-500 text-white text-xs font-semibold rounded-full shadow-lg">
        {{ $t('game_list.made_by_me') }}
      </div>
    </div>
